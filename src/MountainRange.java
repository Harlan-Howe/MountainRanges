...
public class MountainRange
{
    ...
    public void run()
    {
        ...
        mountainAPosition = getIntInRange(-MAX_HEIGHT,MAX_WIDTH+MAX_HEIGHT,"What is the horizontal location of Mountain A's peak?");
        mountainAHeight = getIntInRange(1,MAX_HEIGHT, "What is the height of Mountain A's peak?");

        mountainBPosition = getIntInRange(-MAX_HEIGHT,MAX_WIDTH+MAX_HEIGHT,"What is the horizontal location of Mountain B's peak?");
        mountainBHeight = getIntInRange(1,MAX_HEIGHT, "What is the height of Mountain B's peak?");

        mountainCPosition = getIntInRange(-MAX_HEIGHT,MAX_WIDTH+MAX_HEIGHT,"What is the horizontal location of Mountain C's peak?");
